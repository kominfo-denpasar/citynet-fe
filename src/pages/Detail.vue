														...
														<div class="p-4 sm:p-5">
															<div class="mb-2 flex w-full sm:items-center gap-x-5 sm:gap-x-3">
																...
																<p class="text-sm text-gray-400 dark:text-neutral-400">
																	Leyla is a Customer Success Specialist at Preline and spends her time speaking
...
<!-- <template> <div class="p-6"> <router-link to="/list" class="text-blue-600
hover:underline">&larr; Back to List</router-link> <div v-if="loading"
class="mt-4 text-gray-500">Loading detail...</div> <div v-else class="mt-4"> <h1
class="text-2xl font-bold mb-2">{{ post.title }}</h1> <p
class="text-gray-700">{{ post.body }}</p> </div> </div> </template> -->
